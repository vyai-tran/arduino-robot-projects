...
| **Day 2** | 21/04/2026 | Mechanical Structure | Prototyping, Kinematics | Doing |  |
| **Day 3** | 22/04/2026 | Distance Sensing | Ultrasonic Sensors |  Planned |  |

---

##  Tech Stack
* **Microcontroller:** Arduino Uno
* **Programming:** C++ (Arduino Sketch), Python
